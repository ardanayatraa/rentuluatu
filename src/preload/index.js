...
contextBridge.exposeInMainWorld('api', {
  ...
  getMotors: (params) => invoke('motor:get-all', params),
  ...
  getHotels: (params) => invoke('hotel:get-all', params),
